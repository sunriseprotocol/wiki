...
| 2a. | Liquidity Pool Management | We will create functions that will implement liquidity management samples included below<br />Pool Creation<br />Add liquidity<br /> Remove Liquidity |
| 2b. | Swap Functionality | We will create functions that will implement swap functionality including samples included below <br /> Pool Creation<br />Add liquidity<br /> Remove Liquidity <br />[Reference Implementation from Balancer](https://github.com/balancer-labs/balancer-core/blob/master/contracts/BMath.sol)|
